...
func (e *Engine) loadOWASPRules(paranoiaLevel int) {
	owaspRules := []*Rule{
		...
		// ================================================================
		{
			...
			Category: "protocol", Severity: "high", Paranoia: 1,
		...
		},
		{
			...
			Category: "protocol", Severity: "medium", Paranoia: 1,
		...
		},
		{
			...
			Category: "protocol", Severity: "high", Paranoia: 2,
		...
		// ================================================================
		{
			...
			Category: "lfi", Severity: "critical", Paranoia: 1,
		...
		},
		{
			...
			Category: "lfi", Severity: "high", Paranoia: 1,
			Targets: []string{"URL"}, Operator: "rx",
		...
		// ================================================================
		{
			...
			Category: "xss", Severity: "critical", Paranoia: 1,
		...
		},
		{
			...
			Category: "xss", Severity: "high", Paranoia: 1,
		...
		// ================================================================
		{
			...
			Category: "sqli", Severity: "critical", Paranoia: 1,
		...
		},
		{
			...
			Category: "sqli", Severity: "high", Paranoia: 1,
			Targets: []string{"ARGS", "URL"}, Operator: "rx",
		...
		// ================================================================
		{
			...
			Category: "rce", Severity: "critical", Paranoia: 1,
		...
		// ================================================================
		{
			...
			Category: "rfi", Severity: "critical", Paranoia: 1,
		...
		// ================================================================
		{
			...
			Category: "rce", Severity: "critical", Paranoia: 2,
			Targets: []string{"ARGS", "URL"}, Operator: "rx",
		...
		// ================================================================
		{
			...
			Category: "scanner", Severity: "high", Paranoia: 1,
		...
		// ================================================================
		{
			...
			Category: "ssrf", Severity: "critical", Paranoia: 1,
			Targets: []string{"ARGS"}, Operator: "rx",
	...
	for _, rule := range owaspRules {
		if rule.Paranoia <= paranoiaLevel {
			if rule.Operator == "rx" && rule.Pattern != "" {
				...
				if err != nil {
					log.Printf("[WAF] Failed to compile rule %s: %v", rule.ID, err)
					continue
				}
	...
	log.Printf("[WAF] Initialized OWASP Regex Rule Engine: %d rules loaded (Paranoia %d)", loaded, paranoiaLevel)
}
